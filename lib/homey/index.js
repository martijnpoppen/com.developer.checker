...
class Api {
    constructor(params) {
        ...
        this.otp = params.otp;
        this.client_id = decrypt('5d329db533dbd3ac921d7e2177e2f5da+61350ddfd77c2e25852dc0f02a99e9bdab47a47b41615327');
        this.client_secret = decrypt('5d329db533dbd3ac921d7e2177e2f5da+366d0c88892a7720877f97f17ccceaecad13a47f15605027c9b19b1e64e728e05762558dc34a4334');
        this.redirect_uri = decrypt('5d329db533dbd3ac921d7e2177e2f5da+3c7841cb9c736039c272caad3bd5bdbbed46ff21533c446b93e795492af971f616');
    ...
    _authorize = async function () {
        ...
        const apiUrl = `https://accounts.athom.com/authorise?client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&response_type=code&user_token=${login.token}&state=auth-callback&origin=apps`;
        const options = {
            method: 'GET',
            mode: 'cors',
            credentials: 'include'
